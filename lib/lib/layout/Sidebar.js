...
function (_Component) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !(nextProps.keys === this.props.keys && nextProps.width === this.props.width && nextProps.height === this.props.height && nextProps.headerHeight === this.props.headerHeight && (0, _generic.arraysEqual)(nextProps.groups, this.props.groups) && (0, _generic.arraysEqual)(nextProps.groupHeights, this.props.groupHeights));
    }
  }, {
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        className: 'rct-sidebar-resize' + (isRightSidebar ? ' rct-sidebar-resize-right' : ''),
